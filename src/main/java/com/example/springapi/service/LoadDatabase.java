...
import com.example.springapi.model.IImagemRepository;
...
public class LoadDatabase {
    ...
    CommandLineRunner initDatabase(IProdutoRepository repository) {
        return args -> {
            ...
            // ****************************************************************
            Path path = Paths.get("src/main/resources/img/produto1.jpg");
            ...
            // ****************************************************************
            path = Paths.get("src/main/resources/img/produto2.jpg");
            ...
            imagemRepository.save(imagem);
            // ****************************************************************
            path = Paths.get("src/main/resources/img/produto3.jpg");
            file = Files.newInputStream(path);
